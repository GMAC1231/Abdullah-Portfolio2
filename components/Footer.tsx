    ...
    <footer className="site-footer">
      <div className="site-container footer-grid">
        ...
        <div className="footer-socials">
          ...
          <a href={contactLinks.whatsapp} target="_blank" rel="noreferrer" aria-label={`Chat with Abdullah on WhatsApp at ${contactLinks.phone}`}><FaWhatsapp size={18} /></a>
      ...
      <div className="site-container footer-bottom">
        ...
        <span>Pakistan · <a className="footer-phone-link" href={contactLinks.whatsapp} target="_blank" rel="noreferrer" aria-label={`Chat with Abdullah on WhatsApp at ${contactLinks.phone}`}>{contactLinks.phone}</a></span>
      </div>
    </footer>
  );
}
